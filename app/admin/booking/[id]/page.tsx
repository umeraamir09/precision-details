      ...
      <div className="mt-6 grid gap-6">
        ...
        <section className="rounded-2xl border border-white/10 bg-card/70 p-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
            ...
            <div><div className="text-muted-foreground text-xs">Car type</div><div className="text-white">{('car_type' in booking && (booking as BookingRow & { car_type?: string | null }).car_type ? String((booking as BookingRow & { car_type?: string | null }).car_type).replace(/^./, c=>c.toUpperCase()) : 'Sedan')}</div></div>
          </div>
          <div className="mt-3">
