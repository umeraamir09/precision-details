...
const tiers = [
  {
    ...
    price: 119,
    period: "per car",
    link: "https://cal.com/precisiondetails/bronze",
    features: [
  ...
  },
  {
    ...
    price: 149,
    period: "per car",
    link: "https://cal.com/precisiondetails/silver",
    features: [
  ...
  },
  {
    ...
    price: 179,
    period: "per car",
    link: "https://cal.com/precisiondetails/gold",
    features: [
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {tiers.map((tier) => (
            <div
              key={tier.name}
              className={`relative rounded-2xl border bg-card/60 p-6 shadow-lg backdrop-blur-sm ${
